...
import { uploadRenterProofOfReturn } from "../../services/contractServices/rentalContract";
...
const UploadProofOfReturn = ({
  ...
  const handleSubmit = async (e) => {
    ...
    if (handleImageUpload(image)) {
      ...
      try {
        await uploadRenterProofOfReturn(
          rentalContractAddress,
          renterEthAccountAddress,
          imageIpfsUrl
        );
  ...
  return (
    <Container>
      <div>Renter to upload proof of return</div>
      <InputContainer>
        <Uploader
          type="file"
...
export default UploadProofOfReturn;
